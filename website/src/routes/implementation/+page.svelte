<script>
    ...
    let links = [
        ...
        { name: "Associated Projects", href: "#associated-projects" },
...
<div class="flex w-full">
    ...
    <div class="flex-none col hidden w-64 ps-8 xl:text-sm xl:block end-0">
    ...
    <div class="flex flex-col">
        <h1>SSiRC Implementation Plan</h1>
        <p class="font-light italic text-sm text-gray-700">May 2019 - by the SSiRC Science Steering Group</p>
        <p>
            SSiRC addresses critical elements of the World Climate Research Program (WCRP) mission by focusing on the
            most variable component of climate forcing: stratospheric aerosol. At most times, aerosol above the
            tropopause is an optically thin veil with little impact on climate but it can intensify dramatically due to
            massive, aperiodic volcanic eruptions. Following such events, the stratospheric aerosol influences the
            Earth's climate by cooling the planet as a whole and creating potentially devastating changes to regional
            weather patterns that can persist for a number of years. In the modern era, large volcanic events can
            temporarily slow the pace of human-derived global warming. Since 2012, SSiRC has worked to build and support
            a community focused on the scientific understanding of stratospheric sulfur and aerosol, and their role in
            climate. The SSiRC community has been built through two general workshops on stratospheric aerosol (Atlanta,
            2013; Potsdam, 2016), one workshop focused on measurement of stratospheric aerosol (Boulder, 2017), and a
            Chapman Conference on stratospheric aerosol in the post Pinatubo era (Tenerife, 2018). Furthermore, a
            subgroup that focuses on a rapid response to an ongoing volcanic eruption to determine the potential climate
            impact (VolRes) has been formed. This groups is supported by the development of the Model Intercomparison
            Project on the climatic response to Volcanic forcing (VolMIP , Zanchettin et al., 2016); and a new
            Interactive Stratospheric Aerosol Model Intercomparison Project (ISA-MIP, Timmreck et al., 2018). The SSiRC
            community also contributed to the development of long-term stratospheric aerosol forcing datasets for
            climate modeling (GloSSAC , Thomason et al., 2018). A key contribution to the stratospheric aerosol research
            was the publication of the first extensive review of the status of stratospheric aerosol (Kremser et al.,
            2016) since the SPARC Assessment of Stratospheric Aerosol Properties (ASAP ) was published in 2006.
        </p>
        <p>
            Through these contributions, the SSiRC Scientific Steering Group (SSG) believes that SSiRC has proven to be
            ...
            climate resulting from the warming induced by increasing atmospheric carbon dioxide. For SSiRC to remain
            ...
            modelling, and the wider global climate modelling communities. This document summarizes where SSiRC is and
        ...
        <p>
            ...
            questions relevant to SSiRC, SPARC and the WCRP. For instance, a key knowledge gap is understanding the
        ...
        <p>
            SSiRC addresses these knowledge gaps through directly stimulated activities and associations with related
            but independently managed projects. The following projects are presently active areas of work or subject of
            proposals currently underway, and have been at least partly stimulated by SSiRC.
        </p>

        <h2 id="ssirc-projects">SSiRC Projects</h2>
        <p>
        ...
        <p>
            ...
            wiki, we will add a page to the SSiRC web site to promote key data sets available at data centers around the
            world.
        </p>
        ...
        <p>
            ...
            between GeoMIP and SSiRC science interests is clear. GeoMIP is an endorsed MIP as part of CMIP6.
        </p>
        <p>
        ...
        <p>
            ...
            associated with SPARC stratospheric aerosol projects beginning with ASAP in 2006 and continuing with SSiRC.
        ...
        <p>
            The SSiRC SSG is committed to supporting these activities and others that advance an improved understanding
            ...
            for SSiRC activities to the SSiRC SSG. Promoting these activities through general workshops, topic-specific
        ...
        <p>
            ...
            eruptions. SSiRC is committed to encourage these and other activities related to the role of the UTLS as a
        ...
        <p>
            SSiRC needs to continue to reach out to the broader scientific community. This includes improving
            connectivity with other SPARC activities such as the Atmospheric Composition and the Asian Monsoon (ACAM)
        ...
        <p>
            We would also like to improve the diversity of the SSiRC Scientific Steering group and the SSiRC membership
            as reflected in our email distribution list and in attendance at SSiRC and SSiRC-sponsored workshops. In
            ...
            demands on financial support in a period when support from SPARC is increasingly limited. Part of outreach
            will require us to be more creative in how we acquire support in the future. We plan major updates to our
            web sites at SPARC and at SSiRC to reflect our commitment to diversity as well as our updated science focus
            and workshop planning.
        </p>
        <p>
            Meetings are a key part of making SSiRC a unique community. Workshops (both general and topical) allow
            unique gatherings where the state of the art of SSiRC-related science can be assessed. At the moment,
            ...
            eruptions. EGU and AGU sessions for topical SSiRC related activities are also encouraged.
        </p>
