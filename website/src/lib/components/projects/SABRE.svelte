...
<Project title={"SABRE"} leads={["Troy Thornberry", "Eric Jensen"]} newproject>
    {#snippet children()}
        <div>
            The NOAA <Link href={"https://csl.noaa.gov/projects/sabre/"}>SABRE</Link> (Stratospheric Aerosol processes, Budget
