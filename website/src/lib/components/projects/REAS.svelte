...
<Project title={"REAS"} leads={["Nicolas Dumelie", "Jean-Paul Vernier", "Gwenael Berthet"]} newproject>
    {#snippet children()}
        <div>
            The REAS, Rapid Balloon Experiments for Sudden Aerosol Injection in the Stratosphere, {@html refs.cite(
                "dumelie2024",
            )}
            project is a collaboration between NASA, CNRS-Orleans and the University of Reims to launch instrumented balloons
