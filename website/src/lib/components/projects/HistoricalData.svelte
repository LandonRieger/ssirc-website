...
<Project title={"Recovery of historical data"} leads={["Juan Carlos Antuña-Marrero", "Eduardo Landulfo"]}
    >{#snippet children()}
        <div>
            ...
            datasets from the 1991 Mt. Pinatubo eruption (Antuña-Marrero et al., 2020) and three rescued and
            recalibrated datasets from the 1963 Mt. Agung eruption (Antuña-Marrero et al., 2021; Antuña-Marrero et al.,
            2024). All five rescued datasets are publicly available at PANGAEA data repository. The activity will
            continue to pursue data recovery from sites around the globe with some emphasis on the global south.
            Projects with local funding are being proposed to fund part of this effort for the next 5 years, starting in
            the first semester of 2026. For the 2025 - 2030 period, the data recovery project will cover the following
            specific tasks:
