    ...
    {#snippet children()}
        ...
        <div>
            ...
            <ul class="list-disc list-inside my-2">
                <li>Rapid production of SO2 mass estimates and vertical distributions after eruptions.</li>
                <li>Organization of VolRes sessions at large conferences (AGU, EGU).</li>
                <li>
