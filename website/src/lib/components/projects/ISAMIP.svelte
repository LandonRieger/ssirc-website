...
<Project title={"ISA-MIP"} leads={["Graham Mann", "Timofei Sukhodolov", "Margot Clyne"]} ongoing>
    {#snippet children()}
        <div>
            The multi-modeling initiative with closest alignment to the Stratospheric Aerosol Activity continues to be
            <Link href={"https://isamip.eu/home"}>ISA-MIP</Link>, which defined in 2018 {@html refs.cite(
                "timmreck2018",
            )} four co-ordinated multi-model experiments for composition climate models with interactive stratospheric aerosol.
            ...
            <ul class="list-disc list-inside my-2">
                <li>the background/quiescent stratospheric aerosol layer (BG experiment)</li>
                <li>the post-2000 transient stratospheric aerosol record (TAR experiment)</li>
                <li>historical major volcanic aerosol clouds (HErSEA and PoEMS experiments)</li>
            </ul>
            After the CoViD period, ISA-MIP resumed multi-model analysis, and benchmark papers in 2023 and 2024 have analysed
            intercomparisons for BG {@html refs.cite("brodowsky2024")} and HErSEA-Pinatubo experiments {@html refs.cite(
                "quaglia2023",
            )}.
        </div>
        <div>
        ...
        <div>
            ...
            including with the new emission-based volcanic forcing dataset {@html refs.cite("aubry2025")}.
        </div>
        <div>
